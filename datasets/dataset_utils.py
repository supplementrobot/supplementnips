...
def make_collate_fn(dataset: OxfordDataset, mink_quantization_size=None):
    ...
    def collate_fn(data_list):
        ...
        if 'clouds' in data_list[0]:
            ...
            if dataset.set_transform is not None and args.dataset in ['oxford','oxfordadafusion']:
                # Apply the same transformation on all dataset elements
                clouds = dataset.set_transform(clouds) # rotate flip for [oxford, oxfordadafusion]
